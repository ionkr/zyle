...
export const ko: Translations = {
  ...
  ai: {
    ...
    settings: {
      ...
      providerHint: 'Anthropic API는 API 키가 필요하고, Claude CLI는 로컬 Extension이 필요합니다.',
      apiKey: 'Anthropic API Key',
      apiKeyPlaceholder: 'sk-ant-api03-...',
      apiKeyHint: 'API 키는 브라우저 로컬 스토리지에 암호화되어 저장됩니다.',
      ...
      bridge: {
        status: 'Bridge 서버 상태',
        checking: '확인 중...',
        running: 'Bridge 서버 실행 중',
        notRunning: 'Bridge 서버 미실행',
        claudeCliMissing: 'Claude CLI 미인증',
        ready: '사용 준비 완료',
        installGuide: '설치 가이드',
        installBridgeApp: 'Bridge 서버를 실행하세요',
        ...
        notRunningGuide: {
          title: 'Claude Code Bridge 서버 필요',
          description: 'AI 분석을 사용하려면 Bridge 서버를 실행해야 합니다.',
          command: '터미널에서 실행:',
          copy: '복사',
          copied: '복사됨!',
          retry: '재시도',
        ...
        notAuthenticated: {
          title: 'Claude CLI 인증 필요',
          description: 'Claude CLI에 로그인되어 있지 않습니다.',
          command: '터미널에서 실행:',
          loginCommand: 'claude login',
        },
        statusMessages: {
          serverRunning: 'Bridge 서버는 실행 중입니다.',
          allReady: 'Bridge 서버와 Claude CLI가 정상 연결됨',
        },
      },
    },
    followUp: {
